        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-purple-900 p-6 rounded-lg transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-purple-800 p-4 rounded-lg text-center">
                            <span class="block text-yellow-400 text-3xl font-bold mb-2"><?php echo e(count($temoignages)); ?></span>
                            <span class="text-purple-200">Temoignages</span>
                        </div>
                        <div class="bg-purple-800 p-4 rounded-lg text-center">
                            <span class="block text-yellow-400 text-3xl font-bold mb-2"><?php echo e(count($recettes)); ?></span>
                ...
                <div class="bg-purple-900 p-6 rounded-lg transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $TopTemoignage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-purple-800 p-4 rounded-lg flex items-center justify-between">
                                <div>
                                    <h4 class="font-bold"><?php echo e($item->titre); ?></h4>
                                    <p class="text-purple-200 text-sm"><i class="fas fa-user text-purple-200 mr-1"></i>
                                        <?php echo e($item->user->first_name); ?> <?php echo e($item->user->last_name); ?></p>
                                </div>
                                <div class="text-yellow-400">
                                    <span class="font-bold"><i class="far fa-comment mr-1"></i><?php echo e($item->commentaire_count); ?></span>
                                </div>
                            </div>
