        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-purple-800 rounded-xl shadow-2xl overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <!-- Login Form -->
                    <form id="loginForm" action="<?php echo e(route('login.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                        ...
                        <p class="text-center text-sm">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-yellow-400 hover:text-yellow-300 font-medium">
                                Inscrivez-vous
                            </a>
                        </p>
                    </form>
...
<?php endif; ?><?php /**PATH C:\Users\ycode\Desktop\Briefs\Ramad_On\resources\views/auth/login.blade.php ENDPATH**/ ?>